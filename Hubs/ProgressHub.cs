...
namespace DGS
{
    ...
    {
        public string iDocumentServerid { get; set; }
        public string iCultureid { get; set; }
        public string iDocCultureid { get; set; }
        public string UserInSession { get; set; }
        public string DestinationServerURL { get; set; }
        public string iDocumentServerDestinationid { get; set; }
    ...
    public enum DocumentStatus
    {
        ...
        Translated,
        CreateNewDocument,
        SettingUpNewTranslatedDocument,
        TranslatedDocumentAlreaadyExit,
        CreatingDocument,
        Uploading,
        Uploaded,
        Failed,
    ...
    public class showBarHub : Microsoft.AspNet.SignalR.Hub
    {
